...
import 'package:flutter_task/app/data/network/api-exception.dart';
import 'package:flutter_task/helpers/alert-manager.dart';
...
class ApiService {
  ...
  Future<Map<String, dynamic>> postReq(String url, dynamic body,
    ...
    final responseJson = json.decode(response.body);
    print(dotenv.env['API_BASE_URL'] + url);
